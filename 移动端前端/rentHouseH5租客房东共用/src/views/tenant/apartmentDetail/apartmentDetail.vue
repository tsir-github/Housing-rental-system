...
<script setup lang="ts" name="TenantApartmentDetail">
import { getApartmentDetailById, getRoomListByApartmentId } from "@/api/tenant/search";
import { onMounted, ref } from "vue";
import type { ApartmentInterface } from "@/api/tenant/search/types";
...
const getApartmentDetailHandle = async () => {
  const { data } = await getApartmentDetailById(route.params.id as string);
