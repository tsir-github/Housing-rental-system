...
<script setup lang="ts" name="TenantMyAppointment">
import { onMounted, ref } from "vue";
import { useRouter } from "vue-router";
import type { AppointmentItemInterface } from "@/api/tenant/search/types";
import { getMyAppointmentList } from "@/api/tenant/search";
import {
  AppointmentStatus,
