...
<script setup lang="ts" name="TenantMyAgreement">
import { onMounted, ref } from "vue";
import { useRouter, useRoute } from "vue-router";
import type { AgreementItemInterface } from "@/api/tenant/search/types";
import { getMyAgreementList, saveOrUpdateAgreement } from "@/api/tenant/search";
...
const goAgreementDetail = (
  ...
  router.push({
    path: `/tenant/agreement/${item.id}`,
    query: { 
      from: route.query.from || '/tenant/myAgreement',
      ...query 
    }
  });
};
