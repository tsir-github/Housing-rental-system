...
public class ApartmentController {
    ...
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current, @RequestParam long size, ApartmentQueryVo queryVo) {
        Page<ApartmentItemVo> page = new Page<>(current,size);//要自定意，否则只会查询ApartmentInfo表中信息，无扩展部分
    ...
    public Result<List<ApartmentInfo>> listInfoByDistrictId(@RequestParam Long id) {//此id为区县id
