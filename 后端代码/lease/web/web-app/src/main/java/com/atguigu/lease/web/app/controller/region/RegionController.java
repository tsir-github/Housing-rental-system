...
public class RegionController {
    ...
    public Result<List<CityInfo>> listCityInfoByProvinceId(@RequestParam Integer id) {
    ...
    public Result<List<DistrictInfo>> listDistrictInfoByCityId(@RequestParam Integer id) {
