...
export const CreatorTypeMap = [
  { label: '官方', value: CreatorType.OFFICIAL },
  { label: '房东', value: CreatorType.LANDLORD },
]
//	用户账号状态 "0": "禁用","1": "正常"
...
// 直接入住申请状态
export enum DirectMoveInStatus {
  PENDING = 1,
  APPROVED = 2,
  REJECTED = 3,
}
export const DirectMoveInStatusMap = [
  { label: '待处理', value: DirectMoveInStatus.PENDING },
  { label: '已确认', value: DirectMoveInStatus.APPROVED },
  { label: '已拒绝', value: DirectMoveInStatus.REJECTED },
]
...
export const LandlordStatusMap = [
  { label: '正常', value: LandlordStatus.NORMAL },
  { label: '暂停', value: LandlordStatus.SUSPENDED },
  { label: '封禁', value: LandlordStatus.BANNED },
]
...
export const ProcessorTypeMap = [
  { label: '官方人员', value: ProcessorType.OFFICIAL },
  { label: '房东', value: ProcessorType.LANDLORD },
]
...
export const PublisherTypeMap = [
  { label: '官方发布', value: PublisherType.OFFICIAL },
  { label: '房东发布', value: PublisherType.LANDLORD },
]
...
export const GuideTypeMap = [
  { label: '官方带看', value: GuideType.OFFICIAL },
  { label: '房东带看', value: GuideType.LANDLORD },
]
