...
export interface RoomInterface {
  ...
  reviewInfo?: {
    ...
    photoQualityScore?: number | string
    descriptionAccuracyScore?: number | string
    facilityCompletenessScore?: number | string
    locationAccuracyScore?: number | string
