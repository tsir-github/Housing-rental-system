    ...
    <el-scrollbar>
      ...
      >
        ...
        <el-sub-menu index="3">
          ...
          <el-menu-item index="/rentManagement/appointment">
            <el-icon>
          ...
          <el-menu-item index="/rentManagement/agreement">
            <el-icon>
        ...
        <el-menu-item index="/landlordManagement/landlordPermission">
          <el-icon>
            <component is="UserFilled"></component>
          </el-icon>
          <span>房东权限管理</span>
        </el-menu-item>
        <el-menu-item index="/applicationManagement/directMoveIn">
          <el-icon>
            <component is="DocumentChecked"></component>
          </el-icon>
          <span>直接入住申请管理</span>
        </el-menu-item>
        <el-menu-item index="/roomReview/roomReview">
          <el-icon>
            <component is="DocumentChecked"></component>
          </el-icon>
          <span>房源审核管理</span>
